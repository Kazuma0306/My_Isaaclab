...
from .null_command import NullCommand, StepFRToBlockCommand, MultiLegBaseCommand, MultiLegBaseCommand2, MultiLegBaseCommand3, FootstepFromHighLevel, MultiLegBaseCommandEval
...
# --- 設定クラス: CommandTermCfg を継承 ---
@configclass
class MultiLegBaseCommandEvalCfg(CommandTermCfg):

    # 紐づけるコマンドクラス（実装側で MultiLegBaseTargetsCommand を用意）
    class_type: type = MultiLegBaseCommandEval
